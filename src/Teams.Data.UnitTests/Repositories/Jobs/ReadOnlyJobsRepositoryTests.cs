...
//                 dateFilter: new DateFilter(Created: new RangeFilter<DateTime>(createdFrom, null), null),
...
//             var sut = CreateSut();
//             var actual = await sut.GetAsync(
//                 dateFilter: new DateFilter(new RangeFilter<DateTime>(null, createdTo), null),
//                 cancellationToken: TestContext.Current.CancellationToken);
//
//             Assert.Equivalent(expected, actual, true);
//         }
...
//             var sut = CreateSut();
//             var actual = await sut.GetAsync(
//                 dateFilter: new DateFilter(null, new RangeFilter<DateTime>(modifiedFrom, null)),
//                 cancellationToken: TestContext.Current.CancellationToken);
//
//             Assert.Equivalent(expected, actual, true);
//         }
...
//             var sut = CreateSut();
//             var actual = await sut.GetAsync(
//                 dateFilter: new DateFilter(null, new RangeFilter<DateTime>(null, modifiedTo)),
//                 cancellationToken: TestContext.Current.CancellationToken);
//
//             Assert.Equivalent(expected, actual, true);
//         }
