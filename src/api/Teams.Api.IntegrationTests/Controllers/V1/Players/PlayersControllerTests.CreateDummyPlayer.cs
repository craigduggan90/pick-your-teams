...
public static partial class PlayersControllerTests
{
    public class CreateDummyPlayer(ApiWebApplicationFactory factory) : PlayersControllerTestsBase(factory)
    {
        ...
        public async Task ShouldReturnUnprocessableEntity_WhenGameIsAtMaxPlayers()
        {
            ...
            var request = CreateJsonRequest(HttpMethod.Post, $"{Url}/dummy", ValidRequest with { GameId = fullGame.Id });
            WithActorHeaders(request, Organiser);
            ...
            Assert.Contains(
                ...
                GetValidationErrors(problem, nameof(CreateDummyPlayerRequestModel.GameId)));
        }
